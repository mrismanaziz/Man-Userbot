...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/SonicXsap/Sonic-Userbot.git"
)
UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "Sonic-Userbot")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Sonic-Userbot")
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Sonic-Userbot v{BOT_VER} is back up and running!**\n\n"
